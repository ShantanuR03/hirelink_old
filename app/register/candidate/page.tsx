  ...
  return (
    <div className="flex h-screen w-screen">
      ...
      <div className="w-1/4 border-2 border-r-[#e11d48] h-full p-10 flex flex-col justify-center items-center  gap-5">
        <h1 className="text-2xl">Upload Your Resume Here</h1>
        ...
        {/* Register button */}
        <button
          className="bg-black h-[50px] w-[200px] text-white px-2 rounded-md m-10
              "
      ...
      <div className="flex flex-col w-3/4 p-10 pr-40 overflow-scroll">
        ...
        {blurredBackground && !loadingState && ( // Apply blur if blurredBackground is true
          <div className="flex flex-col w-3/4 h-full p-5 overflow-scroll absolute backdrop-blur-sm">
            <h1 className="text-3xl font-bold mx-auto my-auto bg-[#f7e0e0] p-8 rounded-2xl">
        ...
        {loadingState && (
          <div className="flex flex-col w-3/4 h-full p-5 overflow-scroll absolute backdrop-blur-sm">
            <div className="mx-auto my-auto h-96 w-96 p-8 rounded-2xl">
              ...
              <Input
                ...
                onChange={(e) =>
                  setResumeInformation({
                    ...resumeInformation,
                    contactInformation: {
                      ...resumeInformation.contactInformation,
        ...
        <div className="flex border w-full border-zinc-100 mb-10  shadow-lg">
          ...
          <div className="flex flex-col  mb-10 ">
                    ...
                    <div className="flex gap-4">
                      <Input
                        ...
                        onChange={(e) =>
                          setResumeInformation({
                            ...resumeInformation,
                            education: resumeInformation.education.map(
                              (item, i) =>
                                i === index
                    ...
                    <div className="flex gap-4">
                        ...
                        onChange={(e) =>
                          setResumeInformation({
                            ...
                            education: resumeInformation.education.map(
                              (item, i) =>
                                i === index
                                  ? { ...item, aggrigateMarks: e.target.value }
                                  : item
                            ),
                          })
                        }
                      ...
                      <button
                        onClick={() =>
                          setResumeInformation({
                            ...resumeInformation,
                            education: resumeInformation.education.filter(
                              (item, i) => i !== index
                            ),
                          })
                        }
                        className="bg-red-500 h-[30px] w-[30px] text-white px-2 rounded-full"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="15"
                        ...
                        >
                          <path
                            fill="currentColor"
                            d="M7.615 20q-.69 0-1.152-.462Q6 19.075 6 18.385V6H5V5h4v-.77h6V5h4v1h-1v12.385q0 .69-.462 1.152q-.463.463-1.153.463h-8.77Zm2.193-3h1V8h-1v9Zm3.384 0h1V8h-1v9Z"
                          />
                        </svg>
                      </button>
                    </div>
            ...
            <button
              ...
              className="bg-black h-[50px] w-[150px] text-white px-2 rounded-md m-10 "
            >
              Add Education
            </button>
          </div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setResumeInformation({
                            ...resumeInformation,
                            workExperience:
                              resumeInformation.workExperience.map((item, i) =>
                                i === index
                    ...
                    <button
                      onClick={() =>
                        setResumeInformation({
                          ...resumeInformation,
                          workExperience:
                            resumeInformation.workExperience.filter(
                              (item, i) => i !== index
                            ),
                        })
                      }
            ...
            <button
              onClick={() =>
                setResumeInformation({
                  ...resumeInformation,
                  workExperience: [
                    ...resumeInformation.workExperience,
                    {
                      jobTitle: "",
                      company: "",
                      location: "",
        ...
        <div className="flex border w-full border-zinc-100 mb-10  shadow-lg">
          ...
          <div className="flex flex-col w-auto p-10">
                    ...
                    <div className="flex justify-center items-center gap-4">
                      <Input
                        ...
                        onChange={(e) =>
                          setResumeInformation({
                            ...resumeInformation,
                            skills: resumeInformation.skills.map((item, i) =>
                      ...
                      <button
                        onClick={() =>
                          setResumeInformation({
                            ...resumeInformation,
                            skills: resumeInformation.skills.filter(
                              (item, i) => i !== index
                            ),
                          })
                        }
            ...
            <button
              ...
              className="bg-black h-[40px] w-[100px]  text-white px-2 rounded-md"
            >
              Add Skill
            </button>
          </div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setResumeInformation({
                            ...resumeInformation,
                            certifications:
                              resumeInformation.certifications.map((item, i) =>
                                i === index
                        ...
                        onChange={(e) =>
                          setResumeInformation({
                            ...
                            certifications:
                              resumeInformation.certifications.map((item, i) =>
                                i === index
                                  ? { ...item, issuedDate: e.target.value }
                                  : item
                              ),
                          })
                        }
                      ...
                      <button
                        onClick={() =>
                          setResumeInformation({
                            ...resumeInformation,
                            certifications:
                              resumeInformation.certifications.filter(
                                (item, i) => i !== index
                              ),
                          })
                        }
            ...
            <button
              onClick={() =>
                setResumeInformation({
                  ...resumeInformation,
                  certifications: [
                    ...resumeInformation.certifications,
                    {
                      name: "",
                      issuingOrganization: "",
                      issuedDate: "",
                  ...
                  <div className="flex gap-4 p-5">
                    <div className="flex gap-4">
                      <Input
                        ...
                        onChange={(e) =>
                          setResumeInformation({
                            ...resumeInformation,
                            projects: resumeInformation.projects.map(
                              (item, i) =>
                                i === index
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setResumeInformation({
                          ...resumeInformation,
                          projects: resumeInformation.projects.map((item, i) =>
                            i === index
                              ? { ...item, description: e.target.value }
                              : item
                          ),
                    ...
                    <button
                      onClick={() =>
                        setResumeInformation({
                          ...resumeInformation,
                          projects: resumeInformation.projects.filter(
                            (item, i) => i !== index
                          ),
                        })
                      }
                    ...
                    <div className="flex gap-4">
                      <Input
                        ...
                        onChange={(e) =>
                          setResumeInformation({
                            ...resumeInformation,
                            achievements: resumeInformation.achievements.map(
                              (item, i) =>
                                i === index
                                  ? { ...item, title: e.target.value }
                                  : item
                      ...
                      <button
                        onClick={() =>
                          setResumeInformation({
                            ...resumeInformation,
                            achievements: resumeInformation.achievements.filter(
                              (item, i) => i !== index
                            ),
                          })
                        }
            ...
            <button
              onClick={() =>
                setResumeInformation({
                  ...resumeInformation,
                  achievements: [
                    ...resumeInformation.achievements,
                    { title: "", date: "" },
                  ],
                })
              }
